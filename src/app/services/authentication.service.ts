...
// Register
register(name:string, email:string, address:any,mobilenumber:any, password:string, password_confirmation:string){
  const data={
    name:name,
    email:email,
    address:address,
...
// Forgot Pass
forgot(email:string){
  return this.http.post('http://127.0.0.1:8000/api/forgot', {email:email});
}
